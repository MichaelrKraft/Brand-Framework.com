    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-zinc-800 rounded-2xl p-8 border border-zinc-700">
        ...
        <textarea
          ...
          className="w-full h-32 p-4 border border-zinc-600 rounded-xl bg-zinc-900 text-white placeholder-zinc-500 focus:border-sky-500 focus:ring-1 focus:ring-sky-500 resize-none"
      ...
      <div className="flex justify-between mt-6">
        <button
          ...
          className="px-6 py-3 text-zinc-400 font-medium hover:text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          ← Back
        </button>
        ...
        {isLastStep ? (
          <button
            ...
            disabled={isGenerating}
            className="px-8 py-3 bg-sky-600 text-white rounded-full font-semibold hover:bg-sky-500 disabled:bg-zinc-700 disabled:text-zinc-500 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
          >
            {isGenerating ? (
              <>
          ...
          <button
            onClick={handleNext}
            disabled={isGenerating}
            className="px-8 py-3 bg-sky-600 text-white rounded-full font-semibold hover:bg-sky-500 disabled:bg-zinc-700 disabled:text-zinc-500 disabled:cursor-not-allowed transition-colors"
          >
            Next →
          </button>
        )}
